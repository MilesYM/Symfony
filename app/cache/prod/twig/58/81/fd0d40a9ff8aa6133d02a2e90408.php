...
\t<form action=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ymtest_EditArtist", array("id" => $this->getAttribute((isset($context["artist"]) ? $context["artist"] : null), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
\t\t\t\t\t";
        // line 22
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "name"), 'label', array("label" => "Artist Name"));
        echo "
\t\t\t\t\t";
        // line 23
...
\t\t\t\t\t";
        // line 27
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "biography"), 'label', array("label" => "Artist Biography"));
        echo "
\t\t\t\t\t";
        // line 28
...
\t\t\t\t\t";
        // line 29
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "biography"), 'widget', array("attr" => array("class" => "span10"), "id" => "wysiwyg"));
        echo "
\t\t\t\t</div>
\t\t\t\t</br>
\t\t\t\t";
